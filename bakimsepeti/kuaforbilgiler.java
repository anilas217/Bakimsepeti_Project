...
public class kuaforbilgiler extends AppCompatActivity {         //FOR SPİNNER

FirebaseAuth firebaseAuth=FirebaseAuth.getInstance();
FirebaseUser firebaseUser=firebaseAuth.getCurrentUser();
    FirebaseDatabase database = FirebaseDatabase.getInstance();
    DatabaseReference myRef = database.getReference("isletmekuaför");
...
Button ileri;
    ...
    private String[] ilDüzce={"Akçakoca", "Düzce Merkez", "Yığılca", "Cumayeri", "Gölyaka", "Çilimli", "Gümüşova", "Kaynaşlı"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kuaforbilgiler2);
...
ileri=(Button)findViewById(R.id.okey);
        ...
        ilin.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if(parent.getSelectedItem().toString().equals(iller[0])){
                    dataAdapterForIlceler = new ArrayAdapter<String>(kuaforbilgiler.this, android.R.layout.simple_spinner_item,ilAdana);
                }
                else if(parent.getSelectedItem().toString().equals(iller[1])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilAdıyaman);
                }
                else if(parent.getSelectedItem().toString().equals(iller[2])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilAfyonkarahisar);
                }
                else if(parent.getSelectedItem().toString().equals(iller[3])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilAğrı);
                }
                else if(parent.getSelectedItem().toString().equals(iller[4])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilAmasya);
                }
                else if(parent.getSelectedItem().toString().equals(iller[5])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilAnkara);
                }
                else if(parent.getSelectedItem().toString().equals(iller[6])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilAntalya);
                }
                else if(parent.getSelectedItem().toString().equals(iller[7])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilArtvin);
                }
                else if(parent.getSelectedItem().toString().equals(iller[8])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilAydın);
                }
                else if(parent.getSelectedItem().toString().equals(iller[9])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilBalikesir);
                }
                else if(parent.getSelectedItem().toString().equals(iller[10])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilBilecik);
                }
                else if(parent.getSelectedItem().toString().equals(iller[11])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilBingöl);
                }
                else if(parent.getSelectedItem().toString().equals(iller[12])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilBitlis);
                }
                else if(parent.getSelectedItem().toString().equals(iller[13])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilBolu);
                }
                else if(parent.getSelectedItem().toString().equals(iller[14])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilBurdur);
                }
                else if(parent.getSelectedItem().toString().equals(iller[15])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilBursa);
                }
                else if(parent.getSelectedItem().toString().equals(iller[16])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilÇanakkale);
                }
                else if(parent.getSelectedItem().toString().equals(iller[17])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilÇankırı);
                }
                else if(parent.getSelectedItem().toString().equals(iller[18])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilÇorum);
                }
                else if(parent.getSelectedItem().toString().equals(iller[19])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilDenizli);
                }
                else if(parent.getSelectedItem().toString().equals(iller[20])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilDiyarbakır);
                }
                else if(parent.getSelectedItem().toString().equals(iller[21])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilEdirne);
                }
                else if(parent.getSelectedItem().toString().equals(iller[22])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilElazığ);
                }
                else if(parent.getSelectedItem().toString().equals(iller[23])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilErzincan);
                }
                else if(parent.getSelectedItem().toString().equals(iller[24])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilErzurum);
                }
                else if(parent.getSelectedItem().toString().equals(iller[25])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilEskişehir);
                }
                else if(parent.getSelectedItem().toString().equals(iller[27])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilGiresun);
                }
                else if(parent.getSelectedItem().toString().equals(iller[28])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilGümüşhane);
                }
                else if(parent.getSelectedItem().toString().equals(iller[29])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilHakkari);
                }
                else if(parent.getSelectedItem().toString().equals(iller[30])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilHatay);
                }
                else if(parent.getSelectedItem().toString().equals(iller[31])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilIsparta);
                }
                else if(parent.getSelectedItem().toString().equals(iller[32])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilMersin);
                }
                else if(parent.getSelectedItem().toString().equals(iller[33])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilİstanbul);
                }
                else if(parent.getSelectedItem().toString().equals(iller[34])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilİzmir);
                }
                else if(parent.getSelectedItem().toString().equals(iller[35])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilKars);
                }
                else if(parent.getSelectedItem().toString().equals(iller[36])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilKastamonu);
                }
                else if(parent.getSelectedItem().toString().equals(iller[37])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilKayseri);
                }
                else if(parent.getSelectedItem().toString().equals(iller[38])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilKırklareli);
                }
                else if(parent.getSelectedItem().toString().equals(iller[39])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilKırşehir);
                }
                else if(parent.getSelectedItem().toString().equals(iller[40])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilKocaeli);
                }
                else if(parent.getSelectedItem().toString().equals(iller[41])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilKonya);
                }
                else if(parent.getSelectedItem().toString().equals(iller[42])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilKütahya);
                }
                else if(parent.getSelectedItem().toString().equals(iller[43])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilMalatya);
                }
                else if(parent.getSelectedItem().toString().equals(iller[44])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilManisa);
                }
                else if(parent.getSelectedItem().toString().equals(iller[45])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilKahramanmaraş);
                }
                else if(parent.getSelectedItem().toString().equals(iller[46])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilMardin);
                }
                else if(parent.getSelectedItem().toString().equals(iller[47])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilMuğla);
                }
                else if(parent.getSelectedItem().toString().equals(iller[48])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilMuş);
                }
                else if(parent.getSelectedItem().toString().equals(iller[49])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilNevşehir);
                }
                else if(parent.getSelectedItem().toString().equals(iller[50])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilNiğde);
                }
                else if(parent.getSelectedItem().toString().equals(iller[51])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilOrdu);
                }
                else if(parent.getSelectedItem().toString().equals(iller[52])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilRize);
                }
                else if(parent.getSelectedItem().toString().equals(iller[53])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilSakarya);
                }
                else if(parent.getSelectedItem().toString().equals(iller[54])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilSamsun);
                }
                else if(parent.getSelectedItem().toString().equals(iller[55])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilSiirt);
                }
                else if(parent.getSelectedItem().toString().equals(iller[56])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilSinop);
                }
                else if(parent.getSelectedItem().toString().equals(iller[57])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilSivas);
                }
                else if(parent.getSelectedItem().toString().equals(iller[58])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilTekirdağ);
                }
                else if(parent.getSelectedItem().toString().equals(iller[59])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilTokat);
                }
                else if(parent.getSelectedItem().toString().equals(iller[60])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilTrabzon);
                }
                else if(parent.getSelectedItem().toString().equals(iller[61])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilTunceli);
                }
                else if(parent.getSelectedItem().toString().equals(iller[62])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilŞanlıurfa);
                }
                else if(parent.getSelectedItem().toString().equals(iller[63])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilUşak);
                }
                else if(parent.getSelectedItem().toString().equals(iller[64])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilVan);
                }
                else if(parent.getSelectedItem().toString().equals(iller[65])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilYozgat);
                }
                else if(parent.getSelectedItem().toString().equals(iller[66])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilZonguldak);
                }
                else if(parent.getSelectedItem().toString().equals(iller[67])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilAksaray);
                }
                else if(parent.getSelectedItem().toString().equals(iller[68])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilBayburt);
                }
                else if(parent.getSelectedItem().toString().equals(iller[69])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilKaraman);
                }
                else if(parent.getSelectedItem().toString().equals(iller[70])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilKırıkkale);
                }
                else if(parent.getSelectedItem().toString().equals(iller[71])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilBatman);
                }
                else if(parent.getSelectedItem().toString().equals(iller[72])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilŞırnak);
                }
                else if(parent.getSelectedItem().toString().equals(iller[73])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilBartın);
                }
                else if(parent.getSelectedItem().toString().equals(iller[74])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilArdahan);
                }
                else if(parent.getSelectedItem().toString().equals(iller[75])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilIğdır);
                }
                else if(parent.getSelectedItem().toString().equals(iller[76])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilYalova);
                }
                else if(parent.getSelectedItem().toString().equals(iller[77])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilKarabük);
                }
                else if(parent.getSelectedItem().toString().equals(iller[78])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilKilis);
                }
                else if(parent.getSelectedItem().toString().equals(iller[79])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilOsmaniye);
                }
                else if(parent.getSelectedItem().toString().equals(iller[80])){
                    dataAdapterForIlceler=new ArrayAdapter<String>(kuaforbilgiler.this,android.R.layout.simple_spinner_item,ilDüzce);
                }
                dataAdapterForIlceler.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                ilcenin.setAdapter(dataAdapterForIlceler);
        ...
        ileri.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(tarif.isEmpty()){
                    Toast.makeText(kuaforbilgiler.this,"Lütfen adres tarifini doldurun",Toast.LENGTH_LONG).show();
                    ...
                    String calisanisim=getIntent().getStringExtra("Employename");
                    String telno=getIntent().getStringExtra("Phonenumm");
                    String mekanisim=getIntent().getStringExtra("Compname");
                   String uniqueId = firebaseUser.getUid();
                    ...
                    myRef.child(uniqueId).child("permisson").setValue(permisson);
                    Toast.makeText(kuaforbilgiler.this,"Kayıt oluşturuldu",Toast.LENGTH_LONG).show();
                    Intent intenet=new Intent(kuaforbilgiler.this,mekanarayuz.class);
